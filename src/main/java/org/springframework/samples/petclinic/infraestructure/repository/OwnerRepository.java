...
//	/**
//	 * Retrieve {@link OwnerE}s from the data store by last name, returning all owners
...
//	 * input for id)
//	 */
	Optional<OwnerEntity> findById(@Nonnull Integer id);

	Optional<OwnerEntity> findByLastNameAndFirstName(String lastName, String firstName);
